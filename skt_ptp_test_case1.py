# case 1
import re
import skt_ptp_test as ptp

#host = '172.100.100.218'; username = 'admin'; password = 'admin'; port = '3/x1/1/c1/1'
...
delay_time = 260; loop_count = 16; print_s = f'\nwindow (2초 간격)으로 계산되는 delay 를 PTSF 발동 조건인 250 ns 이상 변동 ({delay_time}ns)'; loop_bool = ptp.call(device, check_asy, port, ptp_asy, print_s, delay_time, loop_count)
